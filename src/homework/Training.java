...
public class Training {
	...
	private int trainingPeriodInHours = 0;
	private static final int MINIMUM_NUMBER_OF_PARTICIPANT = 4;
	...
	public void start() {
		if (canTrainingBeStarted()) {
			...
			System.out.printf("There is not enough participants enrolled. Required: %d",
				MINIMUM_NUMBER_OF_PARTICIPANT);
		}
	}
